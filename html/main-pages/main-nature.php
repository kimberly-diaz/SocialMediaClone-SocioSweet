        ...
        <div class="main-pages"><!-- Start of main-page div -->
            <div class="left">
                <div class="categories">
                    ...
                    <div class="item nature" onclick="location.href='main-nature.php'"><div class="img"><img src="../../assets/images/icons/nature-2.png" alt="food-icon"></div><p style="color:#F58F8F">NATURE</p></div>
                </div>
