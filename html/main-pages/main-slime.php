        ...
        <div class="main-pages"><!-- Start of main-page div -->
            <div class="left">
                <div class="categories">
                    ...
                    <div class="item slime" onclick="location.href='main-slime.php'"><div class="img"><img src="../../assets/images/icons/slime-2.png" alt="food-icon"></div><p style="color:#F58F8F">SLIME</p></div>
