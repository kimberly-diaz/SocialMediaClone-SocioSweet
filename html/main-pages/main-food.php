        ...
        <div class="main-pages"><!-- Start of main-page div -->
            <div class="left">
                <div class="categories">
                    <div class="item food" onclick="location.href='main-food.php'" ><div class="img"><img src="../../assets/images/icons/food-2.png" alt="food-icon"></div><p style="color:#F58F8F">FOOD</p></div>
