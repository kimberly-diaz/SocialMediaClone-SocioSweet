        ...
        <div class="main-pages"><!-- Start of main-page div -->
            <div class="left">
                <div class="categories">
                    ...
                    <div class="item animals" onclick="location.href='main-animals.php'"><div class="img"><img src="../../assets/images/icons/animals-2.png" alt="food-icon"></div><p style="color:#F58F8F">ANIMALS</p></div>
